...
<details closed>
<summary>/download/ - param: url of tabs/chords page (the param worked great via curl but not through postman, lmk if any probs and we'll encode it or something)</summary>
